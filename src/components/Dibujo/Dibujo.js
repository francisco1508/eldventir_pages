  ...
  render() {
    ...
    return (
          ...
          secondaryColor = "#0000"
                ...
                <img src="./img/rollo_canvas.svg" className="rollo_der"/>
                ...
                <ul>
                  ...
                  <ul>
                    ...
                    <li id="#000000" style={{backgroundColor:"#000000"}}><span></span></li>
                    <li id="#ffffff" style={{backgroundColor:"#ffffff"}}><span></span></li>
                  </ul>
                </div>
                <a id="endBtn" ><button type="button" className="buttons" hidden={!this.state.downloadBtn} onClick={this.onEnd}>Terminar</button></a>
                <a id="downloadBtn" href="" download="Dibujo.jpg"><button type="button" className="buttons" hidden={this.state.downloadBtn} onClick={this.onDownload}>Descargar</button></a>
              </section>
            </main>);
  }
}
